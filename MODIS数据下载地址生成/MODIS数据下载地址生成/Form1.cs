...
namespace MODIS数据下载地址生成
{
    public partial class Form1 : Form
    {
        ...
        string monstr;
        string[] dataContent = {"L3m_MO_SST_4.bz2","L3m_MO_RRS_Rrs_488_4km.bz2",
                                   "L3m_MO_RRS_Rrs_531_4km.bz2","L3m_MO_RRS_Rrs_547_4km.bz2",
                                   "L3m_MO_RRS_Rrs_645_4km.bz2","L3m_MO_RRS_Rrs_667_4km.bz2",
                                   "L3m_MO_CHL_chlor_a_4km.bz2","L3m_MO_PAR_par_4km.bz2"};
        ...
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "A" + monstr + ".L3m_MO_SST_4.bz2\n");
        }

        private void button5_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "A" + monstr + ".L3m_MO_CHL_chlor_a_4km.bz2\n");
        }

        private void button6_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "A" + monstr + ".L3m_MO_PAR_par_4km.bz2\n");
        }

        private void button7_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "A" + monstr + ".L3m_MO_RRS_Rrs_488_4km.bz2\n");
        }

        private void button8_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "A" + monstr + ".L3m_MO_RRS_Rrs_531_4km.bz2\n");
        }

        private void button9_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "A" + monstr + ".L3m_MO_RRS_Rrs_547_4km.bz2\n");
        }

        private void button10_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "A" + monstr + ".L3m_MO_RRS_Rrs_645_4km.bz2\n");
        }

        private void button11_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "A" + monstr + ".L3m_MO_RRS_Rrs_667_4km.bz2\n");
        }

        private void button12_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "T" + monstr + ".L3m_MO_SST_4.bz2\n");
        }

        private void button13_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "T" + monstr + ".L3m_MO_CHL_chlor_a_4km.bz2\n");
        }

        private void button14_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "T" + monstr + ".L3m_MO_PAR_par_4km.bz2\n");
        }

        private void button15_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "T" + monstr + ".L3m_MO_RRS_Rrs_488_4km.bz2\n");
        }

        private void button16_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "T" + monstr + ".L3m_MO_RRS_Rrs_531_4km.bz2\n");
        }

        private void button17_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "T" + monstr + ".L3m_MO_RRS_Rrs_547_4km.bz2\n");
        }

        private void button18_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "T" + monstr + ".L3m_MO_RRS_Rrs_645_4km.bz2\n");
        }

        private void button19_Click(object sender, EventArgs e)
        {
            Clipboard.Clear();
            Clipboard.SetDataObject(nasa + "T" + monstr + ".L3m_MO_RRS_Rrs_667_4km.bz2\n");
        }
    }
}
